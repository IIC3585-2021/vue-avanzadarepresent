...
export default {
  ...
  computed: {
    ...mapState(["weather", "isLoading", "map_opts"]),
    backgroundImg() {
      ...
      if (this.weather.main) {
        ...
        if (200 <= weatherId && weatherId <= 299)
          backgroundStr = "thunder-200.jpg";
        else if (300 <= weatherId && weatherId <= 399)
          backgroundStr = "drizzle-300.jpg";
        else if (400 <= weatherId && weatherId <= 599)
          backgroundStr = "rain-500.jpg";
        else if (600 <= weatherId && weatherId <= 699)
          backgroundStr = "cold-600.jpeg";
        else if (700 <= weatherId && weatherId <= 799)
          backgroundStr = "mist-700.jpg";
        else if (weatherId == 800) backgroundStr = "hot-800.jpeg";
        else if (801 <= weatherId && weatherId <= 899)
          backgroundStr = "clouds-800.jpg";
      }
